...
SECRET_KEY = 'django-insecure-ze-ho0+rrga=mu(ds2o5=vn%pbn@-nxtk-41uu6z!w2o0sz)xl'
...
# Después de login redirigimos al dashboard
LOGIN_REDIRECT_URL = 'index'
# URL or view name where @login_required should redirect (login page)
LOGIN_URL = 'login'
